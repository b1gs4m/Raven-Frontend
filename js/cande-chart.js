    ...
    function (data) {
      ...
      eventMarkers.data([
        ...
        },
        {
          ...
          date: "2020-11-20",
          description:
            "TSMC wins approval from Arizona for $12 billion chip plant",
        },
        {
          symbol: 3,
          date: "2021-07-12",
          description:
            "TSMC and Foxconn reach deals to buy COVID-19 vaccines for Taiwan",
        },
        {
          symbol: 4,
          date: "2021-11-09",
          description:
            "TSMC announces to build a specialty technology fab in Japan with Sony",
        },
        {
          symbol: 5,
          date: "2022-02-24",
          description: "Russia-Ukraine war begins",
        },
        {
          symbol: 6,
          date: "2022-11-15",
          description:
            "Berkshire Hathaway discloses a $4.1 billion stake in TSMC",
        },
      ]);
